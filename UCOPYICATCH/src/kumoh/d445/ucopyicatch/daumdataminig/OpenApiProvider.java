...
import kumoh.d445.ucopyicatch.daumdataminig.response.BlogItemData;

public class OpenApiProvider {
	public static BlogData requestBlogApi(String apiKey, String q,int result, int pageno, String sort,String output) throws Exception 
	{
		//링크 주소 만들기
